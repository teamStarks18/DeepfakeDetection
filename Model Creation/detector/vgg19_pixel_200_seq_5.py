...
class Model(nn.Module):
    def __init__(
        ...
        self.vgg19 = vgg19(pretrained=True)  # Load pre-trained VGG19 model
...
def predict(video_path):
    ...
    model.load_state_dict(torch.load(r"detectors\vgg19_pixel_200_seq_5.pt"))
    model.eval()
