...
class Model(nn.Module):
    def __init__(
        ...
        self.lstm = nn.LSTM(
            1536, hidden_dim, lstm_layers, bidirectional
        )  # Input size for EfficientNet-B3 is 1536
...
def predict(video_path):
    ...
    model.load_state_dict(torch.load(r"detectors\efficientnet_b3.pt"))
    model.eval()
...
# # Example usage:
# video_path = r"C:\Users\mahes\ML\new Deepfake Train Custom\sample real\real_video70.mp4"
