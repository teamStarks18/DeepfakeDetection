...
The aggregator's role is to combine the individual probabilities from all detectors by assigning appropriate weights to each, resulting in a single aggregated probability.
